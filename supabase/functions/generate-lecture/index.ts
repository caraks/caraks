...
- Быть написан на ${langName} языке, в гибридном формате Markdown + LaTeX
- Все математические и физические формулы оформляй через LaTeX:
  * inline-формулы — в одинарных долларах: $E = mc^2$
  * блочные формулы — в двойных долларах на отдельной строке: $$F = G\\frac{m_1 m_2}{r^2}$$
- Используй LaTeX для всех уравнений, переменных, греческих букв и математических символов

ВАЖНО: верни ТОЛЬКО текст лекции в чистом Markdown. Без вступлений, без заключений, без пояснений, без обрамляющих тегов \`\`\`markdown и т.п. Только сама лекция.`;
