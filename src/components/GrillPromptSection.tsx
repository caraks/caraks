...
import { Loader2, Send, Flame, Trash2 } from "lucide-react";
...
import grillPrompt from "../../prompts/grill_mal_meinen_prompt.md?raw";
...
const buildSystemContext = () =>
  `Du bist ein kritischer Prompt-Reviewer. Nutze ausschließlich die folgenden Materialien als Grundlage für deine Antworten. Antworte auf Deutsch.

=== SYSTEM PROMPT (grill_mal_meinen_prompt.md) ===
${grillPrompt}`;

const GrillPromptSection = () => {
...
export default GrillPromptSection;
