...
import errorPrompt from "../../prompts/finde_den_fehler_prompt.md?raw";
...
=== SYSTEM PROMPT (finde_den_fehler_prompt.md) ===
${errorPrompt}

=== LEKTION (${lessonSlug}.md) ===
${lessonContent}`;

const FindErrorSection = () => {
  ...
  // Reset chat when lesson changes — conversation starts only on "Start"
  useEffect(() => {
...
export default FindErrorSection;
