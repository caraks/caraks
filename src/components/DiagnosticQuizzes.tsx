                  ...
                  <TableCell className="text-sm">
                    ...
                    <TableCell>
                      <div className="text-center">
                        ...
                        <Progress value={s.total ? (s.counts.yes / s.total) * 100 : 0} className="h-1.5 mt-1 [&>div]:bg-muted-foreground/40" />
                      </div>
                    </TableCell>
                    <TableCell>
                      <div className="text-center">
                        <span className={`text-sm font-semibold ${s.counts.unsure > 0 ? "text-yellow-600" : "text-muted-foreground"}`}>{s.counts.unsure}</span>
                        <Progress value={s.total ? (s.counts.unsure / s.total) * 100 : 0} className="h-1.5 mt-1 [&>div]:bg-muted-foreground/40" />
                      </div>
                    </TableCell>
                    <TableCell>
                      <div className="text-center">
                        <span className={`text-sm font-semibold ${s.counts.no > 0 ? "text-red-600" : "text-muted-foreground"}`}>{s.counts.no}</span>
                        <Progress value={s.total ? (s.counts.no / s.total) * 100 : 0} className="h-1.5 mt-1 [&>div]:bg-muted-foreground/40" />
                      </div>
                    </TableCell>
                </TableRow>
              );
